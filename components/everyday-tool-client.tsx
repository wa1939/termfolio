...
const toolText = {
  ...
  ar: {
    ...
    download: "تحميل",
    open: "فتح",
    privacy: "بلا تسجيل. بلا قاعدة بيانات. كل شيء يعمل في المتصفح إلا إذا ذُكر غير ذلك.",
    urlPlaceholder: "https://example.com/really/long/link?utm_source=noise",
    shorten: "قصّر الرابط",
    clean: "نظّف الرابط",
    shortNote: "الرابط القصير يُنشأ عبر TinyURL. هذا الموقع لا يخزّن شيئًا.",
    failedShort: "تعذر إنشاء رابط قصير. الرابط المنظف جاهز للنسخ.",
    qrInput: "نص، رابط، رقم، أو بيانات Wi-Fi",
    qrDownload: "تحميل QR",
    whatsappPhone: "رقم الجوال",
    whatsappMessage: "الرسالة الجاهزة",
    ...
    eventDuration: "المدة",
    minutes: "دقيقة",
    makeEvent: "أنشئ ملف .ics",
    imagePick: "اختر صورة",
    imageWidth: "العرض الجديد",
    imageQuality: "الجودة",
    imageRun: "صغّر الصورة",
    imageReady: "الصورة جاهزة للتحميل",
    cardText: "النص الأساسي",
    cardByline: "سطر صغير",
    cardTheme: "النمط",
    cardDownload: "تحميل البطاقة",
    themes: ["Terminal", "نظيف", "دافئ"],
  },
} as const
